...
const faqs = [
  {
    ...
    answer:
      "Our free trial gives you full access to all Sassland features for 14 days. No credit card required. At the end of the trial, you can choose a plan that suits your needs or cancel without any charges.",
  },
  {
    question: "Can I change my plan later?",
    answer:
      "Absolutely! You can upgrade, downgrade, or change your plan at any time. The changes will be reflected in your next billing cycle.",
  },
  {
      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-400">
            Find answers to common questions about Sassland. If you can't find
        ...
        <div className="max-w-3xl mx-auto bg-saas-darkGray rounded-xl p-6 md:p-8 border border-gray-800 card-shadow">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="text-left text-white hover:text-saas-yellow py-4">
                  {faq.question}
                </AccordionTrigger>
